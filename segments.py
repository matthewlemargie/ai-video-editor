...
# Open video
video_input_path = "inputvids/rhettandlink_edit2.mp4"
...
with tqdm(total=total_frames, desc="Processing Frames", unit="frame") as pbar:
    while cap.isOpened():
        ...
        # If the active speaker changes or no speaker is speaking, we save the segment
        if active_speaker_idx != last_speaker_idx and last_speaker_idx != -1:
            start_time = last_speaker_time / fps
            ...
            segment = {
                ...
                "x": int(cropped_faces[0].shape[1] * 0.5),  # Example: Centering the crop
                "y": 0,
                "w": crop_width,
                "h": crop_height
            }
...
segments_output_path = "outputvids/segments.json"
